 ...
 *
 * Revision: $Id: fx.Accordion.js 1524 2007-03-13 20:09:19Z joern $
 *
 */
 ...
 *
 * @example fx.Accordion.setDefaults({
 * 	showSpeed: 1000,
 * 	hideSpeed: 150
 * });
 *
...
jQuery.fn.extend({
	...
	Accordion: function(settings) {
		// setup configuration
		settings = jQuery.extend({}, fx.Accordion.defaults, {
...
jQuery.extend(jQuery.Accordion, {
	...
	setDefaults: function(settings) {
		jQuery.extend(fx.Accordion.defaults, settings);
	}
});
