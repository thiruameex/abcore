<?php
class MW_Cmspro_Model_Mysql4_Category_Tree extends Varien_Data_Tree_Dbp
{
    ...
    public function __construct()
    {
        ...
        parent::__construct(
            $resource->getConnection('cmspro_write'),
            $resource->getTableName('cmspro/category'),
            array(
                Varien_Data_Tree_Dbp::ID_FIELD       => 'category_id',
                Varien_Data_Tree_Dbp::PATH_FIELD     => 'root_path',
    ...
    public function addCollectionData($collection=null, $sorted=false, $exclude=array(), $toLoad=true, $onlyActive = false)
    {
        ...
        if ($onlyActive) {
            ...
            if ($disabledIds) {
                $collection->addFieldToFilter('category_id', array('nin'=>$disabledIds));
            }
